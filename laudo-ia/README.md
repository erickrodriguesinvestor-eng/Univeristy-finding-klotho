...
Modelo e custo controlados por `MODEL` (padrão `claude-sonnet-4-6` — melhor
equilíbrio qualidade/custo para estruturação de texto; `claude-haiku-4-5` para
baratear em escala, ou um modelo mais capaz se a margem comportar).
