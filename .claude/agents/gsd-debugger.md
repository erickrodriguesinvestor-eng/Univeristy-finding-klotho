...
<required_reading>
@/home/user/Univeristy-finding-klotho/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/Univeristy-finding-klotho/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/Univeristy-finding-klotho/.claude
                  → checks /home/user/Univeristy-finding-klotho/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/Univeristy-finding-klotho/.claude/gsd-core
                  → writes to /home/user/Univeristy-finding-klotho/.claude/gsd-core/hooks/
...
@/home/user/Univeristy-finding-klotho/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/Univeristy-finding-klotho/.claude/gsd-core/references/common-bug-patterns.md
