...
Reference full template: `/home/user/Univeristy-finding-klotho/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Univeristy-finding-klotho/.claude/gsd-core/templates/state.md`.
