...
Use template from `/home/user/Univeristy-finding-klotho/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/home/user/Univeristy-finding-klotho/.claude/gsd-core/templates/UI-SPEC.md`
