...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/Univeristy-finding-klotho/.claude/.gsd-surface.json`
(sibling to `/home/user/Univeristy-finding-klotho/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/Univeristy-finding-klotho/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/Univeristy-finding-klotho/.claude/skills`).
...
`/home/user/Univeristy-finding-klotho/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/Univeristy-finding-klotho/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/Univeristy-finding-klotho/.claude/.gsd-surface.json`
Install profile marker: `/home/user/Univeristy-finding-klotho/.claude/.gsd-profile`
Skill dirs: `/home/user/Univeristy-finding-klotho/.claude/skills/gsd-*/`
Engine module: `/home/user/Univeristy-finding-klotho/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/Univeristy-finding-klotho/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
