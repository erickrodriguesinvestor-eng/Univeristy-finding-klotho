...
INSTALL_JS_GLOBAL="/home/user/Univeristy-finding-klotho/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/user/Univeristy-finding-klotho/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
