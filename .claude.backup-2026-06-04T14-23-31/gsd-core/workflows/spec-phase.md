...
```bash
INIT=$(node "/home/user/Univeristy-finding-klotho/.claude/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/user/Univeristy-finding-klotho/.claude/gsd-core/templates/spec.md.
