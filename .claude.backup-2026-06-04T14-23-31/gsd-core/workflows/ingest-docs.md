...
```bash
INIT=$(node "/home/user/Univeristy-finding-klotho/.claude/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/user/Univeristy-finding-klotho/.claude/gsd-core/bin/gsd-tools.cjs" commit \
