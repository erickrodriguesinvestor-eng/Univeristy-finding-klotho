...
```markdown
Read /home/user/Univeristy-finding-klotho/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/Univeristy-finding-klotho/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/Univeristy-finding-klotho/.claude/agents/gsd-ui-checker.md for instructions.
