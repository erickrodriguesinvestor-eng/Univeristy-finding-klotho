...
```
Agent(
  prompt="Read /home/user/Univeristy-finding-klotho/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Univeristy-finding-klotho/.claude/gsd-core/templates/VALIDATION.md`
