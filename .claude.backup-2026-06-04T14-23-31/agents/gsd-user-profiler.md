...
<reference>
@/home/user/Univeristy-finding-klotho/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/Univeristy-finding-klotho/.claude/gsd-core/references/user-profiling.md` to load:
